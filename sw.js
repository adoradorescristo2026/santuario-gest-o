const CACHE = 'santuario-gestao-v1-5-3-login-tesouraria-web';
const ASSETS = [
  ...
  './assets/js/web-sync.js?v=15300', './assets/js/data.js', './assets/js/currency-mask.js', './assets/js/form-fields.js', './assets/js/app.js', './assets/js/treasury-common.js?v=15300', './assets/js/treasury-login.js', './assets/js/treasury-verificacao.js', './assets/js/treasury-panel.js', './assets/js/treasury-internal.js', './assets/js/treasury-internal-operation.js', './assets/js/treasury-external.js?v=15300', './assets/js/treasury-report.js',
